...
export class MovieOutput {
  ...
  displayCurrentMovies(){
    ...
    if(this.currentDisplayedMovies.length > 0){
      ...
      return <p class="no-movies-message">Auf dieser Liste befinden sich momentan keine Filme. Wechsel zu einer anderen Liste um Filme zu dieser Liste hinzufügen.</p>;
    }
    return domElements;
  }
